...
function handleResponse(response) {
    ...
    if (statusCode === 200) {
        ...
        showError("This player is currently injured. Can't make a prediction right now. Please enter another player.");
    } else {
...
function showResult({ prediction, playerName, opponent, gameTime }) {
    ...
    if (prediction !== null && prediction !== undefined) {
        html += `
            <div class="result-item">
                ...
                <span class="result-value prediction-highlight">${prediction.toFixed(1)}</span>
            </div>
        `;
    }
    ...
    if (opponent) {
        html += `
            <div class="result-item">
                ...
                <span class="result-value">${opponent}</span>
            </div>
        `;
    }
    ...
    if (gameTime) {
        html += `
            <div class="result-item">
                ...
                <span class="result-value">${gameTime}</span>
            </div>
        `;
    }
